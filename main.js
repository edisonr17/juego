function main() {
  ...
  const BRICK_GRID =  new Array(BRICK_COLS * BRICK_ROWS);
  var paddleX = 400;
  ...
  function moveAll() {
    ...
    /* colorText(
      "x:" + mouseBrickCol.toFixed(2) + " y:" + mouseBrickRow.toFixed(2) + " col:" + indexUnderMouse,
      mouseX,
      mouseY,
      "yellow"
    );*/
  ...
  function rowColToArrayIndex(col, row){
    return  arrayIndex = BRICK_ROWS* row + col;
  }
